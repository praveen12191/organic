      ...
      <section className="bg-gradient-to-r from-green-600 to-green-400 text-white">
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6">Fresh Organic Products</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our organic products are carefully selected to provide you with
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                We source our products daily from local organic farms to ensure
                maximum freshness.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Our sustainable farming practices help protect the environment
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Browse our collection of fresh organic produce and start living
            healthier today.
          </p>
          <Link
            to="/products"
